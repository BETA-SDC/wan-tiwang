...
8. Click `Export Folder` to write a deck folder under `exports/slides/`, then use the generated `Open Deck` link.
...
8. 点击 `Export Folder`，把演示文件夹写到 `exports/slides/`，然后使用生成的 `Open Deck` 链接。
