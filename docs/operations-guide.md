...
3. Players click `Confirm Answer`, or press `Enter` again after selecting an option. The answer reveal opens automatically after confirmation.
...
1. 打开导出的演示。
2. 玩家点击选项。
3. 玩家点击 `Confirm Answer`，或者选择选项后再次按 `Enter`。确认后答案会自动显示。
